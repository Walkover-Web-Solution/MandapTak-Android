 ...
 */
public class FacebookPhotoGridAdapter extends SelectableAdapter<FacebookPhotoGridAdapter.PhotoViewHolder> {
    ...
    public FacebookPhotoGridAdapter(Context mContext, List<Photo> photos) {
        this.photos = photos;
